( function( $ ) {
  ...
  document.addEventListener("swup:contentReplaced", function() {
    /*scroll to top on mobile after content was loaded*/
    ...
    var elementor_post_css_url = swup_url_data.url.replace('themes/vcard', '') + '/uploads/elementor/css/post-'+page_id+'.css'

    if ( !$("#elementor-post-"+page_id+"-css").length && !$('body').hasClass('single') ) {
